...
public class Constants {
    ...
    public static final String COMMANDS_PATH = "Properties/commands.properties";
    public static final String CONFIG_PATH = "Properties/config.properties";
